...
static void stack_experiment(bool is_linearizable)
{
  ...
  elapsed_time_double = elapsed_time.count()*0.000000001;
  ...
  std::cout << "History length: " << number_of_entries
            << ", compositional: " << elapsed_time_double << " s " << mem_usage(result) << std::endl;
...
static void tbb_comprehensive_worker(
  ...
  tbb::concurrent_unordered_set<char, tbb::tbb_hash<char>, std::equal_to<char>, std::allocator<char>>& concurrent_set)
{
  std::random_device rd;
  std::mt19937 gen(rd());
  std::uniform_int_distribution<> value_dist('\0', worker_configuration.max_value);
...
static void tbb_comprehensive_experiment(bool is_linearizable)
{
  ...
  //constexpr unsigned number_of_threads = 32U;
  //constexpr WorkerConfiguration worker_configuration = {'\24', 70000U};
  constexpr WorkerConfiguration worker_configuration = {'\24', 80000U};
  constexpr unsigned log_size = number_of_threads * worker_configuration.number_of_ops;
  ...
  std::cout << "History length: " << number_of_entries
            //<< ", compositional: " << seconds.count() << " s " << mem_usage(result) << std::endl;
			<< ", compositional: " << milliseconds.count() << " ms " << mem_usage(result) << std::endl;
}
#endif
